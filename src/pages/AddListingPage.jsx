...
import { EDUCATION_CHOICES, EXPERIENCE_CHOICES } from "../data/profileChoices";
import {
  submitListing,
  updateListing,
  getListingBySlug,
    ...
    getListingBySlug(editSlug)
      .then((data) => {
        ...
        setForm((f) => ({
          ...
          photoPreview: data.gallery?.[0]?.src || "",
          coverPosition: data.coverPosition || "center",
          coverZoom: data.coverZoom || 1,
          galleryPreviews: (data.gallery || []).slice(1).map((g) => g.src),
        }));
            ...
            <div>
              ...
              <div className="space-y-5">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                  ...
                  <FormField label="Level of experience" htmlFor="experienceLevel" required>
                    <Select
                      id="experienceLevel"
          ...
          {step === 4 && (
            <div>
              ...
              <div className="rounded-2xl border border-background-200/70 bg-background-100/40 p-6 space-y-5">
                <div className="flex items-center justify-between pb-4 border-b border-background-200/70">
                ...
                {[
                  ...
                  ["Education", form.education || "—"],
                  ["Level of experience", form.experienceLevel || "—"],
                  ["Location", form.location || "—"],
                  ["Phone", form.phone || "—"],
                  ["Email", form.email || "—"],
                  ["Website", form.website || "—"],
                  ["Logo / profile picture", form.logoFile ? form.logoFile.name : "Not uploaded"],
                  ["Cover photo", form.photoFile ? form.photoFile.name : "Not uploaded"],
                  ["Gallery photos", form.galleryFiles.length ? `${form.galleryFiles.length} added` : "None added"],
                ].map(([label, value]) => (
